...
import { SowPreviewPrintButton } from './SowPreviewPrintButton'
...
export default async function SowPreviewPage({
  params,
}: {
    ...
    <div className="min-h-screen bg-[#f5f2ee] print:bg-white">
      ...
      <div className="max-w-4xl mx-auto bg-white shadow-lg min-h-screen print:shadow-none print:min-h-0 print:p-0">
        ...
        <div style={{ paddingLeft: '20px', paddingRight: '20px', paddingBottom: '8px' }}>
          {/* Table Header — no Line Total column */}
          <table className="w-full text-[10px] border-collapse mb-0" style={{ tableLayout: 'fixed' }}>
            <thead>
              <tr className="bg-[#fafaf8] border-b border-[#e8e4e0]">
                ...
                <th className="text-left py-2 px-2 font-semibold text-[#b0a89e] text-[8px] uppercase tracking-wider" style={{ width: '71%', fontFamily: 'var(--font-dm-sans)' }}>Description</th>
                      ...
                      {roomItems.map((item) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="py-1.5 px-2 text-[#3a3530]" style={{ width: '71%', fontFamily: 'var(--font-dm-sans)' }}>
                              {typeInfo && (
        ...
        {!quote.notes && <div style={{ paddingBottom: '80px' }} />}
      </div>
