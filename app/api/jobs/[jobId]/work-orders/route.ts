...
export async function POST(
  ...
  // Fetch existing work orders by job_id so duplicate detection works across all
  // trigger paths (auto-create on approval + manual Sync from quote).
  ...
  // Delete orphaned work orders: those with no trade_id and no trade_name
  // (created by old sync code and invisible to the UI).
